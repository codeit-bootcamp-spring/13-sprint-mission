...
## 주요 변경사항
- 컨트롤러와 서비스 레이어 코드 API 명세에 맞추러 변경.
- 축약어로 된 필드 이름 의미가 명확하게 변경.
- swagger doc 을 이용한 API 문서 작성.

## 스크린샷

## 멘토에게
- railway 서비스를 이용한 배포 주소는 [publish](https://railway-test-production-60ee.up.railway.app/) 입니다.
-
