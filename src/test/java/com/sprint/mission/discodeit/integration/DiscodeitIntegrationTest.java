...
class DiscodeitIntegrationTest {
    ...
    void 사용자_API_생성_목록조회_수정_삭제_성공()
        ...
        MockMultipartFile updatePart = jsonPart(
                "userUpdateRequest",
                updateRequest
        );
    ...
    @Test
    void 사용자_API_중복된_사용자_이름이면_409를_반환한다()
            throws Exception {
        createUser(
                "codeit",
                "first@example.com",
    ...
    void 메시지_API_생성_목록조회_수정_삭제_성공()
        ...
        MockMultipartFile createPart = jsonPart(
