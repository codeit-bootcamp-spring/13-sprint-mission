...
class BasicUserServiceTest {
    ...
    @Test
    void create_비밀번호를_암호화하고_사용자를_생성한다() {
    ...
    @Test
    void update_비밀번호가_없으면_기존_비밀번호를_유지한다() {
        UUID userId = UUID.randomUUID();

        User user = new User(
                "before",
                "before@example.com",
                "encoded-before-password"
        );
        ...
        assertThat(user.getPassword())
                .isEqualTo("encoded-before-password");
