    ...
    class CreatePublicChannel {
        ...
        void should_ReturnCreatedPublicChannel_when_RequestIsValid()
            ...
            mockMvc.perform(
                    ...
                    .andExpect(
                            jsonPath("$.participantUserIds")
                                    .isArray()
                    )
                    .andExpect(
                            jsonPath("$.participantIds")
                                    .isArray()
                    )
                    .andExpect(
    ...
    class CreatePrivateChannel {
        ...
        void should_ReturnCreatedPrivateChannel_when_ParticipantsAreValid()
            ...
            mockMvc.perform(
                    ...
                    .andExpect(
                            jsonPath("$.participantUserIds.length()")
                                    .value(2)
                    )
                    .andExpect(
                            jsonPath("$.participantUserIds[0]")
                                    .value(firstUserId.toString())
                    )
                    .andExpect(
                            jsonPath("$.participantUserIds[1]")
                                    .value(secondUserId.toString())
                    )
                    .andExpect(
                            jsonPath("$.participantIds.length()")
                                    .value(2)
                    );
