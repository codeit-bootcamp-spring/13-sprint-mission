...
public class User implements Serializable {
    ...
    // 생성자 호출
    public User(String username, String email, Long createdAt) throws IOException {
        this(randomUUID(), username, email, System.currentTimeMillis());
    }

    public User(UUID id, String username, String email, Long createdAt) throws IOException {
        this.id=id; // id 초기화
    ...
    public void updateUser(String newUserName, String newEmail, Long updatedAt) throws IOException {
    ...
    private String normalizeUserName(String newUserName) throws IOException {
        if(newUserName.isBlank()){
            throw new IOException("조심하세요! 공백은 불가능합니다...(현재 입력이 \""+newUserName+"\" 입니다)");
        }
        return newUserName;
    }
