...
//    }
//
//    public static void mㅈain(String[] args) {
////        //파일 저장
...
//        //user 단건 조회
//        User findByUserId = userService.findByUser(user2.getUserId());
...
//
//        //채널 메시지 전체 조회
//        List<Message> allByChannelId = messageService.findAllByMessage(channel.getChannelId());
//        System.out.println("공지채널 전체 메시지: " + allByChannelId.size());
//        System.out.println(allByChannelId);
//
