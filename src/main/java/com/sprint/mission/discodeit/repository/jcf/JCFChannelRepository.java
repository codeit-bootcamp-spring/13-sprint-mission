...
public class JCFChannelRepository implements ChannelRepository {
   private final Map<UUID, Channel> data; //실제 채널 데이터를 저장하는 Map
   public JCFChannelRepository() {this.data = new HashMap<>();} //Repository 생성 시 HashMap 초기화
    ...
    @Override //채널 존재 여부 확인. 특정 UUID가 Repository에 존재하는지 확인함
